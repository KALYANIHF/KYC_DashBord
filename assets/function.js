    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
            {
                ...
                data: [`${data0}`,25,50,35,55,65,`${data0}`,25,50,35,55,65],
            },
            {
                label: "shg",
                backgroundColor: "#45c490",
                data: [`${data1}`,15,25,30,47,70,`${data0}`,25,50,35,55,65],
            },
            {
                label: "mfg",
                backgroundColor: "#008d93",
                data: [`${data2}`,47,40,35,22,43,`${data0}`,25,50,35,55,65],
            },
            {
                label: "organization",
                backgroundColor: "#2e5468",
                data: [`${data3}`,20,30,40,50,52,`${data0}`,25,50,35,55,65],
            },
            {
                label: "jlg",
                backgroundColor: "#f51252",
                data: [`${data4}`,25,30,35,45,48,`${data0}`,25,50,35,55,65],
            },
            ],
        },
        options: {
